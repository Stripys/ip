...
font = pygame.font.Font('overdozesans.ttf', 30)
death_font = pygame.font.Font('overdozesans.ttf', 74)
...
button_death_exit = Button(screen_width // 2 - button_width // 2, screen_height // 2, button_width, button_height, "Выйти из игры")
button_death_menu = Button(screen_width // 2 - button_width // 2, screen_height // 2 - 100, button_width, button_height, "Обратно в меню")
...
while run:
    if show_menu:
        ...
        death_text = death_font.render("Вы проиграли", True, RED)
